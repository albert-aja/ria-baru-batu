...
class Pinjaman extends Controller
{
    ...
    {
        return view('admin.kepegawaian.pinjaman.index');
    }

    public function create()
    {
        $option_pegawai = $this->option_pegawai(null);
        return view('admin.kepegawaian.pinjaman.create', compact('option_pegawai'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.kepegawaian.pinjaman.show', compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.kepegawaian.pinjaman.edit', compact('data', 'option_pegawai'));
    }
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return '<a href="' . route('Admin Kepegawaian Pinjaman Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>';
            })
            ->make(true);
    }
