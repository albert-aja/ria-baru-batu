...
class Operasional extends Controller
{
    ...
    {
        return view('operator-excavator.operasional.index');
    }

    public function create()
    {
        return view('operator-excavator.operasional.create');
    }

    public function store(Request $request)
    {
        $peralatan = Excavator::where('operator', Auth::user()->id)->first();
    ...
    public function show($id)
    {
        ...
        return view('operator-excavator.operasional.show', compact('data'));
    }

    public function edit($id)
    {
        $data = ModelsOperasional::findOrFail($id);
        return view('operator-excavator.operasional.edit', compact('data'));
    }
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return '<a href="' . route('Operator Excavator Operasional Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>';
            })
            ->make(true);
    }
