...
class Muatan extends Controller
{
    ...
    {
        return view('operator-excavator.muatan.index');
    }
    ...
    public function create()
    {
        ...
        return view('operator-excavator.muatan.create', compact('option_operator', 'option_supir', 'option_bongkar_muat'));
    }
    ...
    public function show($id)
    {
        ...
        return view('operator-excavator.muatan.show', compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('operator-excavator.muatan.edit', compact('data', 'option_operator', 'option_supir', 'option_bongkar_muat'));
    }
    ...
    public function dt()
    {
        $data = ModelsMuatan::orderBy('tgl')->where('operator', Auth::user()->id);
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return '<a href="' . route('Operator Excavator Muatan Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>';
            })
            ->make(true);
    }
