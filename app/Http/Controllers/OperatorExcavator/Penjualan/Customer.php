...
namespace App\Http\Controllers\OperatorExcavator\Penjualan;
...
class Customer extends Controller
{
    ...
    {
        return view('admin.penjualan.customer.index');
    }
    ...
    {
        return view('admin.penjualan.customer.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.penjualan.customer.show', compact('data'));
    }
    ...
    {
        $data = PenjualanCustomer::findOrFail($id);
        return view('admin.penjualan.customer.edit', compact('data'));
    }
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return '<a href="' . route('Admin Penjualan Customer Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>';
            })
            ->make(true);
    }
}
