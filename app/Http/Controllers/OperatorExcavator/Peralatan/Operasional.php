...
namespace App\Http\Controllers\OperatorExcavator\Peralatan;
...
class Operasional extends Controller
{
    ...
    {
        return view('admin.peralatan.operasional.index');
    }

    public function create()
    {
        $option_jenis = $this->option_jenis(null);
        return view('admin.peralatan.operasional.create', compact('option_jenis'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.peralatan.operasional.show', compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.peralatan.operasional.edit', compact('data', 'option_jenis'));
    }
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return '<a href="' . route('Admin Peralatan Operasional Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>';
            })
            ->make(true);
    }
