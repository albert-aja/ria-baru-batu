...
class Truk extends Controller
{
    ...
    {
        return view('admin.peralatan.truk.index');
    }

    public function create()
    {
        $option_pegawai = $this->option_pegawai(null);
        return view('admin.peralatan.truk.create', compact('option_pegawai'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.peralatan.truk.show', compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.peralatan.truk.edit', compact('data', 'option_pegawai'));
    }
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return '<a href="' . route('Admin Peralatan Truk Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>';
            })
            ->make(true);
    }
