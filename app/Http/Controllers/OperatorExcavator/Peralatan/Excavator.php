...
class Excavator extends Controller
{
    ...
    {
        return view('admin.peralatan.excavator.index');
    }

    public function create()
    {
        $option_pegawai = $this->option_pegawai(null);
        return view('admin.peralatan.excavator.create', compact('option_pegawai'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.peralatan.excavator.show', compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.peralatan.excavator.edit', compact('data', 'option_pegawai'));
    }
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return '<a href="' . route('Admin Peralatan Excavator Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>';
            })
            ->make(true);
    }
