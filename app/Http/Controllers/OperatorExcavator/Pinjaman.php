...
class Pinjaman extends Controller
{
    ...
    {
        return view('operator-excavator.pinjaman.index');
    }

    public function create()
    {
        $option_pegawai = $this->option_pegawai(null);
        return view('operator-excavator.pinjaman.create', compact('option_pegawai'));
    }
    ...
    public function show($id)
    {
        ...
        return view('operator-excavator.pinjaman.show', compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('operator-excavator.pinjaman.edit', compact('data', 'option_pegawai'));
    }
    ...
    public function dt()
    {
        $data = ModelsPinjaman::orderBy('tgl', 'desc')->where('pegawai', Auth::user()->id);
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return '<a href="' . route('Operator Excavator Pinjaman Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>';
            })
            ->make(true);
    }
