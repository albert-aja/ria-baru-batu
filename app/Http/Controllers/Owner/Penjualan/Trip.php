...
class Trip extends Controller
{
    ...
    {
        return view('owner.penjualan.trip.index');
    }
    ...
    public function create()
    {
        ...
        return view('owner.penjualan.trip.create', compact('option_supir'));
    }
    ...
    public function show($id)
    {
        ...
        return view('owner.penjualan.trip.show', compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('owner.penjualan.trip.edit', compact('data', 'option_supir'));
    }
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return '<a href="' . route('Owner Penjualan Trip Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>';
            })
            ->make(true);
    }
