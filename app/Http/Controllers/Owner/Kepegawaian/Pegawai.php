...
class Pegawai extends Controller
{
    ...
    {
        return view('owner.kepegawaian.pegawai.index');
    }

    public function create()
    {
        return view('owner.kepegawaian.pegawai.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('owner.kepegawaian.pegawai.show', compact('data'));
    }

    public function edit($id)
    {
        $data = User::findOrFail($id);
        return view('owner.kepegawaian.pegawai.edit', compact('data'));
    }
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return '<a href="' . route('Owner Kepegawaian Pegawai Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>';
            })
            ->make(true);
    }
}
