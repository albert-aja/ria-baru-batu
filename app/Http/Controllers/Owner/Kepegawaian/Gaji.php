...
class Gaji extends Controller
{
    ...
    {
        return view('owner.kepegawaian.gaji.index');
    }

    public function create()
    {
        $option_pegawai = $this->option_pegawai(null);
        return view('owner.kepegawaian.gaji.create', compact('option_pegawai'));
    }
    ...
    public function show($id)
    {
        ...
        return view('owner.kepegawaian.gaji.show', compact('data'));
    }
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return '<a href="' . route('Owner Kepegawaian Gaji Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>';
            })
            ->make(true);
    }
