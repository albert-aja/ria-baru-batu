...
class Muatan extends Controller
{
    ...
    {
        return view('owner.muatan.index');
    }
    ...
    public function create()
    {
        ...
        return view('owner.muatan.create', compact('option_operator', 'option_supir', 'option_bongkar_muat'));
    }
    ...
    public function show($id)
    {
        ...
        return view('owner.muatan.show', compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('owner.muatan.edit', compact('data', 'option_operator', 'option_supir', 'option_bongkar_muat'));
    }
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return '<a href="' . route('Owner Muatan Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>';
            })
            ->make(true);
    }
