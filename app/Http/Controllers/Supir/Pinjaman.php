...
class Pinjaman extends Controller
{
    ...
    {
        return view('supir.pinjaman.index');
    }

    public function create()
    {
        $option_pegawai = $this->option_pegawai(null);
        return view('supir.pinjaman.create', compact('option_pegawai'));
    }
    ...
    public function show($id)
    {
        ...
        return view('supir.pinjaman.show', compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('supir.pinjaman.edit', compact('data', 'option_pegawai'));
    }
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return '<a href="' . route('Supir Pinjaman Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>';
            })
            ->make(true);
    }
