...
class Gaji extends Controller
{
    ...
    {
        return view('supir.gaji.index');
    }

    public function create()
    {
        $option_pegawai = $this->option_pegawai(null);
        return view('supir.gaji.create', compact('option_pegawai'));
    }
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ->addColumn('action', function ($data) {
                return '<a href="' . route('Supir Kepegawaian Pegawai Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>';
            })
            ->make(true);
    }
