...
class Muatan extends Controller
{
    ...
    {
        return view('admin.muatan.index');
    }
    ...
    public function create()
    {
        ...
        return view('admin.muatan.create', compact('option_operator', 'option_supir', 'option_bongkar_muat'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.muatan.show', compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.muatan.edit', compact('data', 'option_operator', 'option_supir', 'option_bongkar_muat'));
    }
    ...
    public function dt()
    {
        $data = ModelsMuatan::orderBy('tgl', 'desc');
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return '<a href="' . route('Admin Muatan Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>';
            })
            ->make(true);
    }
