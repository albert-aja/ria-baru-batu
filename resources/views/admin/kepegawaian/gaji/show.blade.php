...
<div class="box box-blue">
    ...
    {!! GeneralHelp::get_default_show_footer($data, array(0,1,1), '', route('Admin Kepegawaian Gaji Destroy'), route('Admin Kepegawaian Gaji'), 'Anda yakin ingin menghapus gaji ini?') !!}
</div>
...
@push('breadcrumbs')
    {{ Breadcrumbs::render('Admin Kepegawaian Gaji Show', $data->id) }}
@endpush

@push('page_scripts')
    @include('js.admin.kepegawaian.gaji.show')
@endpush
