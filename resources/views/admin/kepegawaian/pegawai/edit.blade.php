...
<div class="box box-blue">
    ...
    <form class="form-horizontal" id="Form" enctype="multipart/form-data">
        @csrf
        <div class="box-body">
            {!! FormHelp::select(1, 'config_roles', 'name', array('name'), '$0$', 'Level Akses', 'role', 'Level Akses', $data->getRoleNames()->first(), 'name != "Admin" AND name != "Owner"') !!}
...
@push('breadcrumbs')
    {{ Breadcrumbs::render('Admin Kepegawaian Pegawai Edit', $data->id) }}
@endpush

@push('page_scripts')
    @include('js.admin.kepegawaian.pegawai.edit')
@endpush
