...
<div class="box box-blue">
    ...
    <form class="form-horizontal" id="Form" enctype="multipart/form-data">
        ...
        {!! FormHelp::form_footer(route('Admin Kepegawaian Pinjaman Show', $data)) !!}
    </form>
</div>
@endsection

@push('breadcrumbs')
    {{ Breadcrumbs::render('Admin Kepegawaian Pinjaman Edit', $data->id) }}
@endpush

@push('page_scripts')
@include('js.admin.kepegawaian.pinjaman.edit')
@endpush
