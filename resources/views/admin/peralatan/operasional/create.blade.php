...
<div class="box box-blue">
    ...
    <form class="form-horizontal" id="Form" enctype="multipart/form-data">
        ...
        {!! FormHelp::form_footer(route('Admin Peralatan Operasional')) !!}
    </form>
</div>
@endsection

@push('breadcrumbs')
    {{ Breadcrumbs::render('Admin Peralatan Operasional Create') }}
@endpush

@push('page_scripts')
    @include('js.admin.peralatan.operasional.create')
@endpush
