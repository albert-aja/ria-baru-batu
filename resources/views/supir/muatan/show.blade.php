...
@section('content')
    <div class="box box-blue">
        ...
        {!! GeneralHelp::get_default_show_footer($data, array(1,1,1), route('Supir Muatan Edit', $data), route('Supir Muatan Destroy'), route('Supir Muatan'), 'Anda yakin ingin menghapus muatan ini?') !!}
    </div>
@endsection
