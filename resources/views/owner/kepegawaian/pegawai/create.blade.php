...
<div class="box box-blue">
    ...
    <form class="form-horizontal" id="Form" enctype="multipart/form-data">
        @csrf
        <div class="box-body">
            {!! FormHelp::select(1, 'config_roles', 'name', array('name'), '$0$', 'Level Akses', 'role', 'Level Akses', '', 'name != "Owner" AND name != "Owner"') !!}
...
@push('breadcrumbs')
    {{ Breadcrumbs::render('Owner Kepegawaian Pegawai Create') }}
@endpush

@push('page_scripts')
    @include('js.owner.kepegawaian.pegawai.create')
@endpush
