...
<div class="box box-blue">
    ...
    <form class="form-horizontal" id="Form" enctype="multipart/form-data">
        ...
        {!! FormHelp::form_footer(route('Owner Penjualan Customer Show', $data)) !!}
    </form>
</div>
@endsection

@push('breadcrumbs')
    {{ Breadcrumbs::render('Owner Penjualan Customer Edit', $data->id) }}
@endpush

@push('page_scripts')
    @include('js.owner.penjualan.customer.edit')
@endpush
