<script>
    $(document).ready(function () {
        ...
        var table1 = $('#daftar_data_1').DataTable({
            ...
            "serverSide": false,
            "ordering": false,
            "ajax": "{{ route('Owner Tabel Laporan Pemasukan', ['awal' => date('Y-m-d'), 'akhir' => date('Y-m-d'), 'kategori' => 'null']) }}",
            lengthMenu: [
                [5, 10, 25, 100, -1],
                [5, 10, 25, 100, "All"]
            ],
        ...
        function reload_table(){
            ...
            var link = "{{ route('Owner Tabel Laporan Pemasukan', ['awal' => ':periode_awal', 'akhir' => ':periode_akhir', 'kategori' => ':kategori']) }}";
